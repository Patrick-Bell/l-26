...
import TwentyFivePOTM from './2025POTM';
import TwentyFiveLeaderboard from './2025Leaderboards';


const TwentyFiveAwards = () => {
...
export default TwentyFiveAwards